              ...
              <picker mode="selector" :value="gradeIndex" :range="grades" @change="gradeChange">
                <fui-listcell :highlight="false">
                  ...
                  <view>
                    ...
                    <text v-if="isGradeSelect" class="fui-input__placeholder" style="color:#000000">{{form.grade}}</text>
                  </view>
                </fui-listcell>
              </picker>
