  ...
  <view>
    ...
    <view class="container" :style="'margin-top:'+allHeight" v-if="userInfo">
      ...
      <view class="contentitem">
        ...
        <picker @change="changeGender" :range="sexs">
...
import { uniRequest, jumpTo, uploadFile } from "@/utils/tool.js";
export default {
  ...
  methods: {
    selectImg() {
      uni.chooseImage({
        count: 1,
        success: async (res) => {
          console.log("9898相册res", res);
          this.avatarUrl = res.tempFilePaths[0];
          let cloudPhotoPath = await uploadFile({
